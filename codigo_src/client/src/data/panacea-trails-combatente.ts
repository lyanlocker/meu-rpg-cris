...
export const PANACEA_COMBATENTE_TRAILS: PanaceaTrail[] = [
  ...
  },
  {
    ...
    "milestones": [
      {"nex":10,"name":"Cartuchos de ensaio","description":"Uma vez por rodada, quando acerta um ataque com uma arma de fogo ou de disparo, pode gastar 2 PD para aplicar um dos compostos abaixo.\n\nComposto hemolítico: o ataque causa +1d6 de dano químico. Esse dado adicional não é multiplicado em um acerto crítico.\n\nComposto criogênico: o deslocamento do alvo é reduzido em –3m até o início do seu próximo turno. Reduções provenientes de vários disparos não se acumulam.\n\nComposto neuroinibidor: o alvo sofre –2 no próximo teste de ataque que realizar até o início do seu próximo turno."},
      {"nex":40,"name":"Fórmula combinada","description":"Ao utilizar Cartuchos de Ensaio, você pode gastar 4 PD, em vez de 2 PD, para aplicar dois compostos diferentes no mesmo ataque.\n\nOs compostos também são aprimorados:\n\n• o dano hemolítico aumenta para +2d6;\n• a redução criogênica aumenta para –6m;\n• a penalidade neuroinibidora aumenta para –5."},
      {"nex":65,"name":"Saturação química","description":"Quando atinge uma criatura que já tenha sido afetada por um de seus compostos desde o início do seu último turno, ela fica saturada.\n\nEscolha um dos efeitos abaixo:\n\n• sofre 3d8 de dano químico;\n• fica fraca por uma rodada;\n• fica vulnerável por uma rodada;\n• não pode realizar reações por uma rodada.\n\nA criatura pode fazer um teste de Fortitude contra sua DT de Agilidade para evitar o efeito. Você só pode provocar uma saturação por rodada."},
      {"nex":99,"name":"Lote Zero","description":"Uma vez por cena, após acertar um ataque à distância, você pode gastar 6 PD para romper um cartucho experimental de nível máximo.\n\nO alvo atingido e todas as criaturas em um raio de 6m sofrem 6d8 de dano químico, com direito a um teste de Reflexos contra sua DT de Agilidade para reduzir esse dano à metade.\n\nO alvo original do ataque não pode reduzir o dano e também sofre os efeitos dos três Cartuchos de Ensaio simultaneamente.\n\nO disparo costuma deixar névoa colorida, cristalização dos tecidos e sinais biológicos que nem mesmo os pesquisadores da Panacea conseguem explicar completamente."}
    ]
  },
  {
    ...
    "milestones": [
      {"nex":10,"name":"Enxerto instável","description":"Com uma ação de movimento e 2 PD, escolha um dos enxertos abaixo. Ele permanece ativo até o fim da cena. Apenas um enxerto pode permanecer ativo por vez.\n\nEnxerto de carapaça: placas endurecidas crescem ao redor de seus órgãos. Você recebe resistência 2 contra dano balístico, corte, impacto e perfuração.\n\nEnxerto predatório: suas mãos, dentes ou braços se transformam em armas naturais. Você recebe uma arma natural que causa 1d8 de dano de corte ou perfuração, à sua escolha. Ela é uma arma simples, leve e ágil.\n\nEnxerto locomotor: seus membros se alongam ou novas articulações surgem em seu corpo. Você recebe +3m de deslocamento, deslocamento de escalada igual ao seu deslocamento terrestre e +2 em Atletismo."},
      {"nex":40,"name":"Compatibilidade cruzada","description":"Você pode gastar 4 PD para ativar dois enxertos simultaneamente. Se fizer isso, os enxertos recebem os seguintes aprimoramentos:\n\n• Carapaça: a resistência aumenta para 5.\n• Predatório: o dano aumenta para 1d10 e a margem de ameaça torna-se 19.\n• Locomotor: o bônus de deslocamento aumenta para +6m e você ignora terreno difícil.\n\nAo fim da cena, faça um teste de Fortitude DT 20. Se falhar, fica fatigado até o próximo interlúdio."},
      {"nex":65,"name":"Assimilação reativa","description":"Quando sofre dano paranormal, você pode gastar uma reação e 3 PD para adaptar seus enxertos ao elemento que o feriu. Você recebe resistência 10 contra esse elemento até o fim da cena. Só pode manter resistência contra um elemento por vez; utilizar novamente esta habilidade substitui o elemento anterior."},
      {"nex":99,"name":"Produto Alfa","description":"Os três enxertos permanecem permanentemente ativos em suas formas aprimoradas, sem custo de PD e sem provocar fadiga.\n\nUma vez por cena, você também pode gastar 5 PD para entrar em um surto evolutivo até o fim do seu turno. Durante o surto:\n\n• recebe uma ação padrão adicional;\n• aumenta seu alcance corpo a corpo em 3m;\n• seus ataques naturais causam +3d8 de dano;\n• fica imune a efeitos de movimento e condições de paralisia.\n\nAo fim do turno, você perde 2d8 PV, ignorando qualquer resistência. Documentos internos provavelmente não utilizariam mais seu nome, apenas uma designação de produto."}
    ]
  },
  {
