...
export const PANACEA_OCULTISTA_TRAILS: PanaceaTrail[] = [
  {
    "id": "farmacoteurgo-de-durga",
    "name": "Farmacoteurgo de Durgā",
    "class": "ocultista",
  ...
  {
    "id": "custodio-do-inominavel",
    "name": "Custódio do Inominável",
    "class": "ocultista",
  ...
  {
    "id": "cultivador-anomalo-de-sume",
    "name": "Cultivador Anômalo de Sumé",
    "class": "ocultista",
  ...
  {
    "id": "operador-fantasma-de-maximon",
    "name": "Operador Fantasma de Maximón",
    "class": "ocultista",
  ...
  {
    "id": "epidemiologista-oculto-de-wohpe",
    "name": "Epidemiologista Oculto de Wohpe",
    "class": "ocultista",
